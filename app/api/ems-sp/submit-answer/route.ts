...
import { getTopic } from "@/lib/ems-sp-selector";
...
async function handler(req: NextRequest) {
  ...
  try {
    const submission: EmsSpSubmitAnswerRequest = await req.json();
    ...
    const { correct: isCorrect, score } = scoreEmsSpAnswer(
    ...
    const response: EmsSpSubmitAnswerResponse = {
    ...
    console.error("[ems-sp/submit-answer] error:", error);
