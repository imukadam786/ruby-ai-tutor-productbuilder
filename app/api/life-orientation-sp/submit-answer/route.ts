...
import { getTopic } from "@/lib/life-orientation-sp-selector";
...
async function handler(req: NextRequest) {
  ...
  try {
    const submission: LifeOrientationSpSubmitAnswerRequest = await req.json();
    ...
    const { correct: isCorrect, score } = scoreLifeOrientationSpAnswer(
    ...
    const response: LifeOrientationSpSubmitAnswerResponse = {
    ...
    console.error("[life-orientation-sp/submit-answer] error:", error);
...
export const POST = withRubies("life-orientation-sp", handler);
