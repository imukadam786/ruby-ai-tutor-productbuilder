...
import { getTopic } from "@/lib/business-studies-selector";
...
async function handler(req: NextRequest) {
  ...
  try {
    const submission: BusinessStudiesSubmitAnswerRequest = await req.json();
    ...
    const { correct: isCorrect, score } = scoreBusinessStudiesAnswer(
    ...
    const response: BusinessStudiesSubmitAnswerResponse = {
    ...
    console.error("[business-studies/submit-answer] error:", error);
...
export const POST = withRubies("business-studies", handler);
