...
import { getTopic } from "@/lib/technology-sp-selector";
...
async function handler(req: NextRequest) {
  ...
  try {
    const submission: TechnologySpSubmitAnswerRequest = await req.json();
    ...
    const { correct: isCorrect, score } = scoreTechnologySpAnswer(
    ...
    const response: TechnologySpSubmitAnswerResponse = {
    ...
    console.error("[technology-sp/submit-answer] error:", error);
...
export const POST = withRubies("technology-sp", handler);
