...
import { getTopic } from "@/lib/natural-sciences-sp-selector";
...
async function handler(req: NextRequest) {
  ...
  try {
    const submission: NaturalSciencesSpSubmitAnswerRequest = await req.json();
    ...
    const { correct: isCorrect, score } = scoreNaturalSciencesSpAnswer(
    ...
    const response: NaturalSciencesSpSubmitAnswerResponse = {
    ...
    console.error("[natural-sciences-sp/submit-answer] error:", error);
...
export const POST = withRubies("natural-sciences-sp", handler);
