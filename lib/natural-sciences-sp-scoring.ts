...
import type {
  ...
  NaturalSciencesSpHighlightTarget,
  NaturalSciencesSpInputType,
  NaturalSciencesSpItem,
...
function scoreSortBuckets(studentAnswer: string, question: NaturalSciencesSpBankQuestion): ScoreResult {
  const items: NaturalSciencesSpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: NaturalSciencesSpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: NaturalSciencesSpBankQuestion): ScoreResult {
  const targets: NaturalSciencesSpHighlightTarget[] = question.targets ?? [];
...
export function scoreNaturalSciencesSpAnswer(
  inputType: NaturalSciencesSpInputType,
  studentAnswer: string,
  question: NaturalSciencesSpBankQuestion,
): ScoreResult {
