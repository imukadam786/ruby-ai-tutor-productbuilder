 ...
 * lib/creative-arts-sp-scoring.ts. This file just shuffles items and converts
...
export function getTopic(topicId: string): CreativeArtsSpTopic | null {
...
export function selectQuestion(
  ...
  _skillId = "",
  abilityLevel?: number,
): CreativeArtsSpBankQuestion | null {
...
export function bankQuestionToGenerated(
  q: CreativeArtsSpBankQuestion,
  skillId: string,
): CreativeArtsSpGeneratedQuestion {
  return {
    id: `q_ca_${skillId}_${q.ref}_${Date.now()}`,
    skill_id: skillId,
    question_ref: q.ref,
...
export function listTopicsForLevel(
  level: number,
): Array<{ id: string; topic: CreativeArtsSpTopic }> {
