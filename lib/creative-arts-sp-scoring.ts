...
import type {
  ...
  CreativeArtsSpHighlightTarget,
  CreativeArtsSpInputType,
  CreativeArtsSpItem,
...
function scoreSortBuckets(studentAnswer: string, question: CreativeArtsSpBankQuestion): ScoreResult {
  const items: CreativeArtsSpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: CreativeArtsSpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: CreativeArtsSpBankQuestion): ScoreResult {
  const targets: CreativeArtsSpHighlightTarget[] = question.targets ?? [];
...
export function scoreCreativeArtsSpAnswer(
  inputType: CreativeArtsSpInputType,
  studentAnswer: string,
  question: CreativeArtsSpBankQuestion,
): ScoreResult {
