/**
 * History question selector. Direct mirror of lib/life-sciences-selector.ts.
 *
 ...
 *
 * Per-mechanic `expected` payload handling lives in lib/history-scoring.ts.
...
export function getTopic(topicId: string): HistoryTopic | null {
...
export function listTopicsForLevel(
  level: number,
): Array<{ id: string; topic: HistoryTopic }> {
