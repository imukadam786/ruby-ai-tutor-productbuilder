...
import type {
  ...
  TechnologySpHighlightTarget,
  TechnologySpInputType,
  TechnologySpItem,
...
function scoreSortBuckets(studentAnswer: string, question: TechnologySpBankQuestion): ScoreResult {
  const items: TechnologySpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: TechnologySpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: TechnologySpBankQuestion): ScoreResult {
  const targets: TechnologySpHighlightTarget[] = question.targets ?? [];
...
export function scoreTechnologySpAnswer(
  inputType: TechnologySpInputType,
  studentAnswer: string,
  question: TechnologySpBankQuestion,
): ScoreResult {
