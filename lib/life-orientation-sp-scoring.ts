// ─── Natural Sciences SP scoring ──────────────────────────────────────────────
//
// Per-mechanic scorers. Direct mirror of lib/geography-scoring.ts. Each returns
// { correct, score } where:
...
import type {
  ...
  LifeOrientationSpHighlightTarget,
  LifeOrientationSpInputType,
  LifeOrientationSpItem,
...
function scoreSortBuckets(studentAnswer: string, question: LifeOrientationSpBankQuestion): ScoreResult {
  const items: LifeOrientationSpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: LifeOrientationSpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: LifeOrientationSpBankQuestion): ScoreResult {
  const targets: LifeOrientationSpHighlightTarget[] = question.targets ?? [];
...
export function scoreLifeOrientationSpAnswer(
  inputType: LifeOrientationSpInputType,
  studentAnswer: string,
  question: LifeOrientationSpBankQuestion,
): ScoreResult {
