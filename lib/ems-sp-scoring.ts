...
function scoreSortBuckets(studentAnswer: string, question: EmsSpBankQuestion): ScoreResult {
  const items: EmsSpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: EmsSpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: EmsSpBankQuestion): ScoreResult {
  const targets: EmsSpHighlightTarget[] = question.targets ?? [];
...
export function scoreEmsSpAnswer(
  inputType: EmsSpInputType,
  studentAnswer: string,
  question: EmsSpBankQuestion,
): ScoreResult {
