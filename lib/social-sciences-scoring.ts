// ─── Social Sciences answer scoring (shared client + server) ─────────────────
//
// Single source of truth for scoring a deterministic Social Sciences answer
// (Grades 4–6, all input types are deterministic). The server route scores
...
export function scoreSocialSciences(
  inputType: string,
