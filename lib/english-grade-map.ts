...
//
// Content currently spans Levels 1–8 (≈ Grade R–6). Grades 7–12 are allowed:
// they seed at the highest available level (L8) with `beyondContent` true so
// the UI can show "more coming" while still letting them practise.

export const HIGHEST_AVAILABLE_LEVEL = 8;
