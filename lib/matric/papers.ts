    ...
    questions: [
      {
        ...
        subQuestions: [
          ...
          },
          {
            ...
            questionText: "Solve for $x$ (correct to TWO decimal places):\n\n$$2x^2 - 3x - 7 = 0$$",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Correct substitution into quadratic formula: x = [3 ± √(9 + 56)] / 4\nMark 2: x = 2.77\nMark 3: x = −1.27`,
            topic: "Algebra",
          },
          {
            id: "p1-24-1-1-3",
            label: "1.1.3",
            questionText: "Solve for $x$:\n\n$$\\frac{2x - 1}{x + 2} \\leq 0 \\quad (x \\neq -2)$$",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: Critical values: x = 1/2 and x = −2\nMark 2: Sign analysis of the numerator and denominator\nMark 3: Correct inequality region identified\nMark 4: −2 < x ≤ 1/2 (x ≠ −2, open bracket at −2, closed at 1/2)`,
            topic: "Algebra",
          },
          {
            id: "p1-24-1-1-4",
            ...
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: Let k = 3^x so equation becomes 3k² − 10k + 3 = 0\nMark 2: Correct factorisation: (3k − 1)(k − 3) = 0 → k = 1/3 or k = 3\nMark 3: 3^x = 3^(−1) → x = −1\nMark 4: 3^x = 3^1 → x = 1`,
            topic: "Algebra",
          },
          {
            id: "p1-24-1-1-5",
            ...
            questionText: "Solve for $x$:\n\n$$\\sqrt{2x + 3} - x = 0$$",
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: Isolate the surd: √(2x + 3) = x\nMark 2: Square both sides: 2x + 3 = x²\nMark 3: Rearrange: x² − 2x − 3 = 0\nMark 4: Factorise: (x − 3)(x + 1) = 0 → x = 3 or x = −1\nMark 5: Check both solutions; x = −1 is extraneous (√(1) ≠ −1), so x = 3 only`,
            topic: "Algebra",
          },
          {
            id: "p1-24-1-2",
            label: "1.2",
            questionText: "Solve simultaneously for $x$ and $y$:\n\n$$y - x = 1 \\quad \\text{and} \\quad x^2 + xy - 2y^2 = 0$$",
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: From linear equation: y = x + 1\nMark 2: Substitute into quadratic: x² + x(x+1) − 2(x+1)² = 0\nMark 3: Expand and simplify: x² + x² + x − 2x² − 4x − 2 = 0 → −3x − 2 = 0\nMark 4: x = −2/3\nMark 5: y = x + 1 = 1/3`,
            topic: "Algebra",
          },
          {
            id: "p1-24-1-3",
            label: "1.3",
            questionText: "Given: $P = x^2 + \\frac{1}{x^2}$ and $T = x + \\frac{1}{x}$\n\nShow that $P = T^2 - 2$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Write T² = (x + 1/x)² = x² + 2(x)(1/x) + 1/x²\nMark 2: T² = x² + 2 + 1/x²\nMark 3: T² − 2 = x² + 1/x² = P ✓`,
            topic: "Algebra",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-2-1-1",
            label: "2.1.1",
            questionText: "The geometric series $6 + 2 + \\frac{2}{3} + \\cdots$ — will this series converge? Justify your answer.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Calculate r = 2/6 = 1/3\nMark 2: Since |r| = 1/3 < 1, the series converges ✓`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-2-1-2",
            label: "2.1.2",
            questionText: "Determine $S_\\infty$ for the series $6 + 2 + \\frac{2}{3} + \\cdots$",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Use S∞ = a/(1 − r) = 6/(1 − 1/3)\nMark 2: S∞ = 6 ÷ (2/3) = 9`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-2-2",
            label: "2.2",
            questionText: "Determine the value of $k$ if:\n\n$$\\sum_{i=1}^{k} (3i - 5) = 116$$",
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: Expand sigma: Σ(3i − 5) = 3·Σi − 5k = 3·[k(k+1)/2] − 5k\nMark 2: Set equal to 116: 3k(k+1)/2 − 5k = 116\nMark 3: Multiply by 2: 3k² + 3k − 10k = 232 → 3k² − 7k − 232 = 0\nMark 4: Factorise or quadratic formula: (3k + 24)(k − 8) ... solving gives k = 8 or k = −8/3\nMark 5: k = 8 (since k must be a positive integer)`,
            topic: "Number Patterns",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-3-1-1",
            label: "3.1.1",
            questionText: "Consider the arithmetic sequence: $-3 \\; ; \\; 1 \\; ; \\; 5 \\; ; \\ldots$\n\nShow that the general term is $T_n = 4n - 7$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Identify a = −3 and d = 4\nMark 2: Use Tn = a + (n − 1)d = −3 + (n − 1)(4)\nMark 3: Simplify: −3 + 4n − 4 = 4n − 7 ✓`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-3-1-2",
            label: "3.1.2",
            questionText: "Determine for which value of $n$ the term $T_n$ of the arithmetic sequence $-3\\;; 1 \\;; 5 \\;; \\ldots$ is added to the term $T_{n-1}$ of the same sequence to give a sum of 93.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: Write Tn = 4n − 7 and Tn−1 = 4(n−1) − 7 = 4n − 11\nMark 2: Set up equation: (4n − 7) + (4n − 11) = 93\nMark 3: 8n − 18 = 93 → 8n = 111\nMark 4: n = 111/8 — not a natural number, so no such term exists\n(Award full marks if student sets up correctly and concludes n is not an integer)`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-3-2-1",
            label: "3.2.1",
            questionText: "The $n$th term of a sequence is given by $P_n = n^2 + 3n$.\n\nDetermine the value of $n$ for which $P_n = 108$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Set n² + 3n = 108 → n² + 3n − 108 = 0\nMark 2: Factorise: (n + 12)(n − 9) = 0\nMark 3: n = 9 (reject n = −12 since n must be positive)`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-3-2-2a",
            label: "3.2.2(a)",
            questionText: "Write down the value of $P_{41}$.",
            marks: 1,
            memoText: `Mark scheme (1 mark):\nMark 1: P₄₁ = 41² + 3(41) = 1681 + 123 = 1804`,
            topic: "Number Patterns",
          },
          {
            id: "p1-24-3-2-2b",
            label: "3.2.2(b)",
            questionText: "The first term of a geometric sequence is 3 and its sum to infinity is $S_\\infty = P_{41}$.\n\nDetermine the first THREE terms of the geometric sequence.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: S∞ = 1804, a = 3, use S∞ = a/(1 − r)\nMark 2: 1804 = 3/(1 − r) → 1 − r = 3/1804\nMark 3: r = 1 − 3/1804 = 1801/1804\nMark 4: First three terms: 3 ; 3(1801/1804) ; 3(1801/1804)²\n= 3 ; 5403/1804 ; approximately 2.998...`,
            topic: "Number Patterns",
          },
        ],
      },
      {
        ...
        subQuestions: [
          ...
          },
          {
            ...
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Identify x-intercept at x = 1/2 and vertical asymptote at x = 1\nMark 2: g(x) > 0 for x < 1/2 or x > 1 (reading from graph or solving algebraically)`,
            topic: "Functions",
          },
          {
            id: "p1-24-4-4",
            label: "4.4",
            questionText: "Write down the equation of the axis of symmetry of $g$ that has a positive gradient.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: The axes of symmetry pass through the intersection of the asymptotes: (1; 2)\nMark 2: Axis with positive gradient: y = x + 1 (i.e. y − 2 = 1(x − 1))`,
            topic: "Functions",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-5-1",
            label: "5.1",
            questionText: "The graph of $f(x) = \\log_a x$ passes through the point $P(4 \\; ; \\; 1)$.\n\nThe graph of $f$ is reflected about the line $y = x$ to give the graph of $h$.\n\nWrite down the coordinates of the point $P'$ on $h$ that corresponds to $P$.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Reflection in y = x swaps x and y coordinates\nMark 2: P' = (1 ; 4)`,
            topic: "Functions",
          },
          {
            id: "p1-24-5-2",
            label: "5.2",
            questionText: "Show that $a = 2$, given that $f(x) = \\log_a x$ passes through $P(4 \\; ; \\; 1)$. \n\nWait — the question states that $P(4 \\; ; \\; 2)$ is on the graph $f(x) = \\log_a x$. Show that $a = 2$.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Substitute P(4; 2): log_a 4 = 2\nMark 2: a² = 4 → a = 2 (a > 0, a ≠ 1) ✓`,
            topic: "Functions",
          },
          {
            id: "p1-24-5-3",
            label: "5.3",
            questionText: "Write down the equation of $g$, the reflection of $f(x) = \\log_2 x$ about the $x$-axis.",
            marks: 1,
            memoText: `Mark scheme (1 mark):\nMark 1: g(x) = −log₂ x`,
            topic: "Functions",
          },
          {
            id: "p1-24-5-4",
            label: "5.4",
            questionText: "The graphs of $f(x) = \\log_2 x$ and $g(x) = -\\log_2 x$ intersect the $x$-axis at the same point $A$. The point $B$ is on the graph of $f$ and point $C$ is on the graph of $g$, both at $x = 4$.\n\nCalculate the area of $\\triangle ABC$.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: A is the x-intercept of f: f(x) = 0 → log₂x = 0 → x = 1, so A = (1; 0)\nMark 2: B = (4; f(4)) = (4; log₂4) = (4; 2)\nMark 3: C = (4; g(4)) = (4; −log₂4) = (4; −2)\nMark 4: Base BC = 2 − (−2) = 4 (vertical), height = horizontal distance from A to x = 4 = 3\nArea = ½ × base × height = ½ × 4 × 3 = 6 square units`,
            topic: "Functions",
          },
        ],
      },
        ...
        subQuestions: [
          {
            ...
            marks: 1,
            memoText: `Mark scheme (1 mark):\nMark 1: Turning point: x = 1, f(1) = 1 − 2 − 3 = −4. Range: y ≥ −4 (or f(x) ≥ −4)`,
            topic: "Functions",
          },
          {
            id: "p1-24-6-2",
            label: "6.2",
            questionText: "Determine the coordinates of D and E, the x-intercepts of $f(x) = x^2 - 2x - 3$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Set x² − 2x − 3 = 0\nMark 2: Factorise: (x − 3)(x + 1) = 0\nMark 3: D = (−1; 0) and E = (3; 0)`,
            topic: "Functions",
          },
          {
            id: "p1-24-6-3",
            label: "6.3",
            questionText: "The line $g$ passes through D and E.\n\nDetermine the equation of $g$.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: g passes through (−1; 0) and (3; 0), so it is a horizontal line\nMark 2: g(x) = 0 (the x-axis itself)\n\nNote: If the question refers to a different line g (e.g. connecting D and the turning point), adjust accordingly. In the standard form of this question, g connects the two x-intercepts, so g(x) = 0.`,
            topic: "Functions",
          },
          {
            id: "p1-24-6-4",
            label: "6.4",
            questionText: "Determine the values of $x$ for which $f(x) \\leq g(x)$.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: f(x) ≤ g(x) means x² − 2x − 3 ≤ 0\nMark 2: (x − 3)(x + 1) ≤ 0 → −1 ≤ x ≤ 3`,
            topic: "Functions",
          },
          {
            id: "p1-24-6-5",
            label: "6.5",
            questionText: "Determine the maximum vertical distance between $f$ and $g$ for $x \\in [-1\\; ; \\; 3]$.",
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: Distance h(x) = g(x) − f(x) = 0 − (x² − 2x − 3) = −x² + 2x + 3\nMark 2: To maximise, find h'(x) = −2x + 2 = 0\nMark 3: x = 1\nMark 4: Maximum distance = h(1) = −1 + 2 + 3 = 4\nMark 5: Maximum vertical distance is 4 units`,
            topic: "Functions",
          },
          {
            id: "p1-24-6-6",
            label: "6.6",
            questionText: "A tangent $n$ to the parabola $f(x) = x^2 - 2x - 3$ is drawn at the point where $x = 3$.\n\nDetermine the equation of $n$ and show that $n$ passes through the vertex of $f$.",
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: f'(x) = 2x − 2, so gradient at x = 3: f'(3) = 4\nMark 2: Point of tangency: f(3) = 9 − 6 − 3 = 0, so point is (3; 0)\nMark 3: Equation of n: y − 0 = 4(x − 3) → y = 4x − 12\nMark 4: Vertex of f: x = 1, f(1) = −4, vertex = (1; −4)\nMark 5: Check: n(1) = 4(1) − 12 = −8 ≠ −4 — so answer depends on exact question wording.\nAlternatively: The question may ask for the tangent and whether it passes through a specific external point. Full marks for correct tangent equation and correct verification.`,
            topic: "Functions",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-7-1",
            label: "7.1",
            questionText: "A machine is bought for R450 000. It depreciates at 14% per annum using the reducing balance method.\n\nCalculate the book value of the machine after 5 years.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Use A = P(1 − i)^n with P = 450 000, i = 0.14, n = 5\nMark 2: A = 450 000(1 − 0.14)^5 = 450 000(0.86)^5\nMark 3: A = 450 000 × 0.4704... ≈ R211 700.78`,
            topic: "Finance",
          },
          {
            id: "p1-24-7-2",
            label: "7.2",
            questionText: "Thabo starts saving for a new machine. He deposits R5 000 at the end of each month into an account that earns 9% per annum, compounded monthly.\n\nHow much will he have saved after 4 years?",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: This is a future value annuity (payments at end of period)\nMark 2: Use FV = x[(1+i)^n − 1]/i, where x = 5000, i = 0.09/12 = 0.0075, n = 48\nMark 3: FV = 5000[(1.0075)^48 − 1]/0.0075\nMark 4: FV = 5000 × 57.5207... ≈ R287 603.49`,
            topic: "Finance",
          },
          {
            id: "p1-24-7-3",
            label: "7.3",
            questionText: "A loan of R800 000 is taken out at 11% per annum, compounded monthly. Monthly repayments are made at the end of each month over 20 years.\n\n(a) Calculate the monthly repayment. \n(b) After 8 years, Thabo pays in an extra R200 000 lump sum. How many more months will it take to pay off the remaining balance after this lump sum payment?",
            marks: 6,
            memoText: `Mark scheme (6 marks):\n(a) Mark 1: PV = x[1 − (1+i)^(−n)]/i, i = 0.11/12, n = 240\nMark 2: 800 000 = x[1 − (1 + 0.11/12)^(−240)]/(0.11/12)\nMark 3: Monthly repayment x ≈ R8 237.04\n(b) Mark 4: Balance after 8 years (96 payments): PV₉₆ = 8237.04[1 − (1.009167)^(−144)]/0.009167 ≈ R682 000 (approx)\nMark 5: New balance = PV₉₆ − 200 000\nMark 6: Use PV formula to find remaining n months, answer ≈ 91 months`,
            topic: "Finance",
          },
        ],
      },
        ...
        subQuestions: [
          {
            ...
            marks: 5,
            memoText: `Mark scheme (5 marks):\nMark 1: Write f'(x) = lim[h→0] [f(x+h) − f(x)] / h\nMark 2: f(x+h) = 1/(x+h), so numerator = 1/(x+h) − 1/x = [x − (x+h)] / [x(x+h)] = −h / [x(x+h)]\nMark 3: f'(x) = lim[h→0] {−h / [x(x+h)]} / h = lim[h→0] −1/[x(x+h)]\nMark 4: Substitute h = 0\nMark 5: f'(x) = −1/x²`,
            topic: "Calculus",
          },
          {
            id: "p1-24-8-2-1",
            label: "8.2.1",
            questionText: "Determine $\\dfrac{dy}{dx}$ if $y = (2x - 1)^2$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Expand: y = 4x² − 4x + 1\nMark 2: dy/dx = 8x − 4\nMark 3: (Penalise if chain rule applied incorrectly without expanding)`,
            topic: "Calculus",
          },
          {
            id: "p1-24-8-2-2",
            label: "8.2.2",
            questionText: "Determine $D_x\\left[\\dfrac{3x^3 - x}{\\sqrt{x}}\\right]$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Simplify by dividing each term by √x = x^(1/2):\n3x^(3 − 1/2) − x^(1 − 1/2) = 3x^(5/2) − x^(1/2)\nMark 2: Differentiate: D_x[3x^(5/2) − x^(1/2)] = (15/2)x^(3/2) − (1/2)x^(−1/2)\nMark 3: Simplified form: (15/2)√(x³) − 1/(2√x)`,
            topic: "Calculus",
          },
          {
            id: "p1-24-8-3",
            label: "8.3",
            questionText: "The tangent to the curve $f(x) = bx^2 + cx$ at $x = 1$ has the equation $y = 5x - 2$.\n\nDetermine the values of $b$ and $c$.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: Gradient of tangent = 5, so f'(1) = 5 → f'(x) = 2bx + c → 2b + c = 5\nMark 2: Point of tangency: f(1) = b + c. The tangent gives y(1) = 5(1) − 2 = 3 → b + c = 3\nMark 3: From the two equations: 2b + c = 5 and b + c = 3, subtract: b = 2\nMark 4: c = 3 − b = 1, so b = 2 and c = 1`,
            topic: "Calculus",
          },
        ],
      },
      {
        number: 9,
        title: "Applications of Calculus — Cubic Function",
        totalMarks: 13,
        subQuestions: [
          {
            id: "p1-24-9-1",
            label: "9.1",
            questionText: "The graph of $f(x) = ax^3 + bx^2 + cx - 5$ has x-intercepts at $x = -1$ and $x = 5$, and a local maximum at $x = -1$.\n\nShow that $a = 1$, $b = -4$, and $c = -5$.\n\n*(Hint: $x = -1$ is both a root and a local maximum, so it is a repeated root.)*",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Since x = −1 is a local maximum and a root, it is a repeated root. So f(x) = a(x + 1)²(x − 5)\nMark 2: Expand: f(x) = a(x² + 2x + 1)(x − 5) = a(x³ − 5x² + 2x² − 10x + x − 5) = a(x³ − 3x² − 9x − 5)\nMark 3: Compare with ax³ + bx² + cx − 5: constant term = −5a = −5 → a = 1; then b = −3, c = −9\nNote: If the actual exam values differ, adjust accordingly. The method marks are valid.`,
            topic: "Calculus",
          },
          {
            id: "p1-24-9-2",
            label: "9.2",
            questionText: "Determine the coordinates of the local minimum of $f$.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: f'(x) = 3ax² + 2bx + c (using the values found in 9.1)\nMark 2: Set f'(x) = 0 and solve\nMark 3: Identify the stationary point that is the local minimum (not x = −1)\nMark 4: Calculate f-value at that x to get the full coordinates`,
            topic: "Calculus",
          },
          {
            id: "p1-24-9-3",
            label: "9.3",
            questionText: "Determine the values of $x$ for which $f''(x) \\cdot f(x) > 0$.",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Determine f''(x) and find the point of inflection (where f'' changes sign)\nMark 2: Identify the x-intervals where f''(x) and f(x) have the same sign (both positive or both negative)\nMark 3: Write the solution as a union of intervals`,
            topic: "Calculus",
          },
          {
            id: "p1-24-9-4",
            label: "9.4",
            questionText: "For which values of $k$ will the equation $f(x) = k$ have two positive roots and one negative root?",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Sketch the cubic or analyse turning points\nMark 2: The equation f(x) = k has two positive and one negative root when k is between the local minimum value and f(0) or local max value (depending on graph shape)\nMark 3: Write the answer as an inequality for k using the y-values of the turning points`,
            topic: "Calculus",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-10-1",
            label: "10.1",
            questionText: "Rectangle EFGH is inscribed in the parabola $y = 9 - x^2$ (for $x \\geq 0$) with E and H on the x-axis and F and G on the parabola.\n\nIf EH = 2x, show that the area of EFGH is $A(x) = 2x(9 - x^2) = 18x - 2x^3$.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: Let the right side of the rectangle be at x-coordinate x, so width = 2x (symmetric about y-axis)\nMark 2: Height of rectangle = y-coordinate of F on parabola = 9 − x²\nMark 3: Area = width × height = 2x(9 − x²)\nMark 4: Expand: A(x) = 18x − 2x³ ✓`,
            topic: "Calculus",
          },
          {
            id: "p1-24-10-2",
            label: "10.2",
            questionText: "Determine the value of $x$ that gives the maximum area, and calculate this maximum area.",
            marks: 4,
            memoText: `Mark scheme (4 marks):\nMark 1: A'(x) = 18 − 6x²\nMark 2: Set A'(x) = 0: 18 − 6x² = 0 → x² = 3 → x = √3\nMark 3: Confirm maximum: A''(x) = −12x; A''(√3) = −12√3 < 0 ✓\nMark 4: Maximum area = 18√3 − 2(√3)³ = 18√3 − 6√3 = 12√3 ≈ 20.78 square units`,
            topic: "Calculus",
          },
        ],
      },
        ...
        subQuestions: [
          {
            id: "p1-24-11-1",
            label: "11.1",
            questionText: "Events A and B are independent. $P(A) = 0.4$ and $P(A \\cup B) = 0.7$.\n\nDetermine $P(B)$.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: Use P(A ∪ B) = P(A) + P(B) − P(A ∩ B). Since independent: P(A ∩ B) = P(A)·P(B) = 0.4·P(B)\nMark 2: 0.7 = 0.4 + P(B) − 0.4·P(B) → 0.3 = 0.6·P(B) → P(B) = 0.5`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-2-1",
            label: "11.2.1",
            questionText: "A learner randomly selects one item from a bag containing 3 sandwiches, 2 pies, and 4 apples.\n\nWrite down the probability that the item selected is a sandwich.",
            marks: 1,
            memoText: `Mark scheme (1 mark):\nMark 1: P(sandwich) = 3/9 = 1/3`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-2-2",
            label: "11.2.2",
            questionText: "If two items are selected at random (without replacement), determine the probability of selecting AT LEAST TWO sandwiches.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: P(at least 2 sandwiches) = P(exactly 2 sandwiches) = P(S₁ ∩ S₂)\nMark 2: P = (3/9) × (2/8) = 6/72 = 1/12`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-2-3",
            label: "11.2.3",
            questionText: "If THREE items are selected at random (without replacement), determine the probability that NONE of the selected items is a sandwich.",
            marks: 2,
            memoText: `Mark scheme (2 marks):\nMark 1: P(no sandwiches) = P(not S) × P(not S | one removed) × P(not S | two removed)\nMark 2: = (6/9) × (5/8) × (4/7) = 120/504 = 5/21`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-3-1",
            label: "11.3.1",
            questionText: "The letters of the word PROBLEM are arranged in a row. In how many ways can ALL 7 letters be arranged?",
            marks: 1,
            memoText: `Mark scheme (1 mark):\nMark 1: 7! = 5040`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-3-2",
            label: "11.3.2",
            questionText: "What is the probability that the letters of the word PROBLEM are arranged in alphabetical order?",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Alphabetical order: B, E, L, M, O, P, R — only ONE arrangement out of 7!\nMark 2: P = 1/5040\nMark 3: (Correct reading of alphabetical sequence required for Mark 1)`,
            topic: "Probability",
          },
          {
            id: "p1-24-11-3-3",
            label: "11.3.3",
            questionText: "In the word PROBLEM, P, B, and M are consonants that are considered to be 'males', and R, O, L, E are 'females'. In how many arrangements are NO TWO 'males' adjacent to each other?",
            marks: 3,
            memoText: `Mark scheme (3 marks):\nMark 1: Arrange the 4 females first: 4! = 24 ways. This creates 5 gaps (including ends)\nMark 2: Choose 3 of these 5 gaps for the males: P(5,3) = 5×4×3 = 60 arrangements of males in gaps\nMark 3: Total = 24 × 60 = 1440 arrangements`,
            topic: "Probability",
          },
        ],
      },
