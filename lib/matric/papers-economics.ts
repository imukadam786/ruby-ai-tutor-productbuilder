...
import ecoP2_mayJun_2025 from "@/data/papers/eco-p2-may-jun-2025-combined.json";
import ecoP1_mayJun_2025 from "@/data/papers/eco-p1-may-jun-2025-combined.json";
import ecoP2_mayJun_2024 from "@/data/papers/eco-p2-may-jun-2024-combined.json";
...
import ecoP2_mayJun_2022 from "@/data/papers/eco-p2-may-jun-2022-combined.json";
import ecoP1_mayJun_2022 from "@/data/papers/eco-p1-may-jun-2022-combined.json";
import ecoP2_mayJun_2021 from "@/data/papers/eco-p2-may-jun-2021-combined.json";
import ecoP1_mayJun_2021 from "@/data/papers/eco-p1-may-jun-2021-combined.json";
...
export const ECONOMICS_PAPERS: Paper[] = [
  ...
  ecoP2_mayJun_2025 as unknown as Paper,
  ecoP1_mayJun_2025 as unknown as Paper,
  ecoP2_mayJun_2024 as unknown as Paper,
  ecoP1_mayJun_2024 as unknown as Paper,
  ecoP1_mayJun_2023 as unknown as Paper,
  ecoP2_mayJun_2023 as unknown as Paper,
  ecoP2_mayJun_2022 as unknown as Paper,
  ecoP1_mayJun_2022 as unknown as Paper,
  ecoP2_mayJun_2021 as unknown as Paper,
  ecoP1_mayJun_2021 as unknown as Paper,
];
