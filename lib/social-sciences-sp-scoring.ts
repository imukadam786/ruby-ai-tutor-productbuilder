...
import type {
  ...
  SocialSciencesSpHighlightTarget,
  SocialSciencesSpInputType,
  SocialSciencesSpItem,
...
function scoreSortBuckets(studentAnswer: string, question: SocialSciencesSpBankQuestion): ScoreResult {
  const items: SocialSciencesSpItem[] = question.items ?? [];
...
function scoreSequence(studentAnswer: string, question: SocialSciencesSpBankQuestion): ScoreResult {
...
function scoreHighlightSource(studentAnswer: string, question: SocialSciencesSpBankQuestion): ScoreResult {
  const targets: SocialSciencesSpHighlightTarget[] = question.targets ?? [];
...
export function scoreSocialSciencesSpAnswer(
  inputType: SocialSciencesSpInputType,
  studentAnswer: string,
  question: SocialSciencesSpBankQuestion,
): ScoreResult {
