  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4">
      <div
        ...
        style={{ width: isMobile ? "100%" : 420, height: isMobile ? 260 : 300 }}
      >
        {/* Header */}
        ...
        <div className="px-3 pb-3 flex-shrink-0">
          ...
          <div className="flex items-center gap-1 mt-1.5 px-1">
            ...
            <span className="text-[10px] text-[#B7182E] font-medium">Type a question or upload homework here</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="flex-1 px-4 py-3 space-y-3 overflow-hidden">
          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex-1">
              ...
              {/* Play + Hint — RED HIGHLIGHT */}
              <div
                className="flex items-center gap-2 mt-1.5 px-1 py-1 rounded-xl border-2 border-[#B7182E] bg-[#B7182E]/5 w-fit"
...
const STORAGE_KEY = "homework_tutorial_seen";

export function hasSeenHomeworkTutorial(): boolean {
...
export default function HomeworkTutorial({ onComplete }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-end md:items-center justify-center">
      ...
      {/* Card */}
      <div className="relative z-10 bg-white w-full md:w-auto md:min-w-[480px] md:max-w-lg rounded-t-3xl md:rounded-3xl shadow-2xl flex flex-col overflow-hidden"
      ...
      >
        ...
        {/* Text content */}
        <div
          className="px-6 pt-3 pb-2 flex-shrink-0 transition-all duration-200"
          style={{ opacity: slideIn ? 1 : 0, transform: slideIn ? "translateY(0)" : "translateY(8px)" }}
        >
          <h2 className="text-xl font-bold text-[#1a2744] mb-1.5 leading-snug">{current.title}</h2>
        ...
        {/* Bottom nav */}
        <div className="flex items-center justify-between px-6 py-5 flex-shrink-0 border-t border-gray-100">
          <span className="text-xs text-gray-400">{step + 1} of {SLIDES.length}</span>
          <button
            onClick={advance}
            className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#B7182E] text-white text-sm font-semibold hover:bg-[#9a1426] transition-colors active:scale-95"
          >
