    ...
    <div className="w-full h-full flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-100 bg-white flex-shrink-0">
          <div className="w-7 h-7 rounded-full bg-brand-alt flex items-center justify-center text-white text-xs font-bold">R</div>
          <span className="text-sm font-semibold text-gray-800">Chat with Ruby</span>
        </div>

        <div className="flex-1 px-4 py-3 overflow-hidden">
          <div className="flex gap-2 items-start">
            <div className="w-6 h-6 rounded-full bg-brand-alt flex-shrink-0 flex items-center justify-center text-white text-xs font-bold">R</div>
        ...
        <div className="px-3 pb-3 flex-shrink-0">
          <div
            className="flex items-center gap-2 bg-gray-50 border-2 border-brand-alt rounded-2xl px-3 py-2"
            style={{ boxShadow: "0 0 0 3px rgba(183,24,46,0.15)" }}
          >
            <div className="w-7 h-7 rounded-lg bg-brand-alt/10 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-brand-alt" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
              </svg>
            </div>
            <span className="text-xs text-gray-400 flex-1">Ask anything...</span>
            <div className="w-7 h-7 rounded-full bg-brand-alt flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-1 mt-1.5 px-1">
            <div className="w-2 h-2 rounded-full bg-brand-alt flex-shrink-0" />
            <span className="text-[10px] text-brand-alt font-medium">Type a question or tap + to upload homework</span>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        ...
        <div className="flex-1 px-4 py-3 space-y-3 overflow-hidden">
          <div className="flex justify-end">
            <div className="bg-brand-alt text-white rounded-2xl rounded-tr-sm px-3 py-2 text-xs max-w-[70%] leading-relaxed">
          ...
          <div className="flex gap-2 items-start">
            ...
            <div className="flex-1">
              ...
              <div
                className="flex items-center gap-2 mt-1.5 px-2 py-1 rounded-xl border-2 border-brand-alt bg-brand-alt/5 w-fit"
              ...
              <div className="flex items-center gap-1 mt-1 px-1">
                <div className="w-2 h-2 rounded-full bg-brand-alt flex-shrink-0" />
                <span className="text-[10px] text-brand-alt font-medium">Listen to Ruby or ask for a hint</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="w-full h-full flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-gray-100 bg-white flex-shrink-0">
          ...
          <div
            className="p-1.5 rounded-lg border-2 border-brand-alt bg-brand-alt/5"
            style={{ boxShadow: "0 0 0 3px rgba(183,24,46,0.1)" }}
          >
            <svg className="w-3.5 h-3.5 text-brand-alt" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
        ...
        <div className="px-3 pb-3 flex-shrink-0">
          <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-2xl px-3 py-2">
            ...
            <span className="text-xs text-gray-400 flex-1">Ask anything...</span>
            <div
              className="w-7 h-7 rounded-full border-2 border-brand-alt bg-brand-alt/10 flex items-center justify-center flex-shrink-0"
              style={{ boxShadow: "0 0 0 3px rgba(183,24,46,0.1)" }}
            >
              <svg className="w-3.5 h-3.5 text-brand-alt" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="flex items-center gap-1 mt-1.5 px-1">
            <div className="w-2 h-2 rounded-full bg-brand-alt flex-shrink-0" />
            <span className="text-[10px] text-brand-alt font-medium">Speak your question · Clear chat to start fresh</span>
          </div>
        </div>
      </div>
    </div>
