...
// SourceBlock — optional source rendered ABOVE any BusinessStudies mechanic.
...
import type { BusinessStudiesProvenance, BusinessStudiesSource } from "@/types/business-studies";

const HIS_IMAGE_EXTS = ["png", "svg", "jpg", "jpeg", "webp"];

function ProvenanceBadge({ provenance }: { provenance?: BusinessStudiesProvenance }) {
...
export default function SourceBlock({ source }: { source: BusinessStudiesSource }) {
