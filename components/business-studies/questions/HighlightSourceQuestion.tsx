...
// Scoring in lib/business-studies-scoring.ts matches these strings against
// targets[].phrase (normalised) and counts wrong taps.

import { useMemo, useState } from "react";
import type { BusinessStudiesHighlightTarget } from "@/types/business-studies";
...
function tokenise(source: string, targets: BusinessStudiesHighlightTarget[]): Token[] {
