...
// SourceBlock — optional source rendered ABOVE any History mechanic.
...
import type { HistoryProvenance, HistorySource } from "@/types/history";

const HIS_IMAGE_EXTS = ["png", "svg", "jpg", "jpeg", "webp"];

function ProvenanceBadge({ provenance }: { provenance?: HistoryProvenance }) {
...
export default function SourceBlock({ source }: { source: HistorySource }) {
