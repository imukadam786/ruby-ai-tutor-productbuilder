...
// Scoring in lib/history-scoring.ts matches these strings against
// targets[].phrase (normalised) and counts wrong taps.

import { useMemo, useState } from "react";
import type { HistoryHighlightTarget } from "@/types/history";
...
function tokenise(source: string, targets: HistoryHighlightTarget[]): Token[] {
