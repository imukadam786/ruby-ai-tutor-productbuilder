...
// Clone of components/history/questions/SortBucketsQuestion.tsx, retyped for
// the Geography bank. Submits a JSON-stringified { itemId: bucketId } map.
            ...
            return (
              <button
                ...
                className={`min-h-[44px] px-4 py-2 rounded-xl border-2 text-left text-sm sm:text-base font-medium transition-all ${
                  selected
                    ? "bg-sky-100 border-sky-400 text-sky-900 ring-2 ring-sky-300"
          ...
          return (
            <div
              ...
              className={`rounded-2xl border-2 border-dashed p-3 min-h-[120px] transition-colors ${
                pickedUp
                  ? "border-sky-400 bg-sky-50/70 cursor-pointer"
              ...
              <div className="flex flex-col gap-2">
                ...
                {inside.map((it) => (
                  <button
                    ...
                    className="min-h-[44px] px-3 py-2 rounded-xl bg-sky-100 border border-sky-300 text-sm text-sky-900 text-left hover:bg-sky-200"
                    title="Tap to remove"
                  >
                    {it.text}
                  </button>
