...
const SUBJECTS = [
  ...
  {
    id: "life-sciences-ieb",
    name: "Life Sciences (IEB)",
    thumbnail: "/thumbnails/life-sciences.webp",
    color: "from-emerald-500 to-green-600",
    available: true,
  },
