...
// Scoring in lib/accounting-scoring.ts matches these strings against
// targets[].phrase (normalised) and counts wrong taps.

import { useMemo, useState } from "react";
import type { AccountingHighlightTarget } from "@/types/accounting";
...
function tokenise(source: string, targets: AccountingHighlightTarget[]): Token[] {
