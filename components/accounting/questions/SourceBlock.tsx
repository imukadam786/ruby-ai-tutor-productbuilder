...
// SourceBlock — optional source rendered ABOVE any Accounting mechanic.
...
import type { AccountingProvenance, AccountingSource } from "@/types/accounting";

const ACCT_IMAGE_EXTS = ["png", "svg", "jpg", "jpeg", "webp"];

function ProvenanceBadge({ provenance }: { provenance?: AccountingProvenance }) {
...
export default function SourceBlock({ source }: { source: AccountingSource }) {
