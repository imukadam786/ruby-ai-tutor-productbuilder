...
// Scoring in lib/economics-scoring.ts matches these strings against
// targets[].phrase (normalised) and counts wrong taps.

import { useMemo, useState } from "react";
import type { EconomicsHighlightTarget } from "@/types/economics";
...
function tokenise(source: string, targets: EconomicsHighlightTarget[]): Token[] {
