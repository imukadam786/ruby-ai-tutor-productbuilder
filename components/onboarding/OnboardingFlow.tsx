        ...
        <div className="bg-white rounded-3xl shadow-xl flex-1 flex flex-col overflow-hidden min-h-0">
          ...
          {step === 2 && (
            <div className="flex-1 flex flex-col overflow-hidden p-6 min-h-0">
              ...
              <h1 className="text-2xl font-bold text-[#1a2744] mb-6 leading-snug flex-shrink-0">{t.step3Title}</h1>
              <div className="flex-1 overflow-y-auto min-h-0 pb-1">
          ...
          {step === 5 && (
            <div className="flex-1 flex flex-col overflow-hidden p-6 min-h-0">
              <h1 className="text-2xl font-bold text-[#1a2744] text-center mb-6 flex-shrink-0">{t.step7Title}</h1>
              <div className="flex-1 overflow-y-auto min-h-0 pb-1">
                ...
                <div className="flex flex-col gap-4 mb-5">
                  <div>
                    ...
                    <div className="flex items-center gap-3 border-2 border-gray-200 rounded-full px-4 py-3 focus-within:border-blue-400 transition-colors">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-full bg-blue-600 text-white font-semibold text-base disabled:opacity-40 hover:bg-blue-700 transition-colors mb-4"
                >
                  {t.startBtn}
                </button>
          ...
          {step === 6 && (
            <div className="flex-1 flex flex-col overflow-hidden p-6 min-h-0">
              ...
              {/* Mobile: one card at a time, scroll horizontally */}
              <div className="md:hidden flex overflow-x-auto snap-x snap-mandatory flex-1 min-h-0 gap-4 -mx-6 px-6 pb-2 scrollbar-hide">
                {PLANS.map((plan) => (
                  <div
                    key={plan.id}
                    className={`flex-shrink-0 w-full snap-center border-2 ${plan.borderClass} rounded-2xl p-5 flex flex-col overflow-y-auto`}
                  >
                    ...
                    <button
                      ...
                      className={`w-full py-3.5 rounded-full text-white font-semibold text-base transition-colors flex-shrink-0 ${plan.btnClass}`}
                    >
                      {t.selectPlan}
                    </button>
                  </div>
